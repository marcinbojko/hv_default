...
@powershell Enable-NetFirewallRule -DisplayGroup "'iSCSI Service'" -Direction "'Outbound'"
@powershell Enable-NetFirewallRule -DisplayGroup "'iSCSI Service'" -Direction "'Inbound'"
